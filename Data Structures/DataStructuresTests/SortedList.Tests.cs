...
namespace DataStructuresTests
{
    public class SortedListTests
    {
        ...
        {
            var array = new DataStructures.SortedListCollection<int> { 0, 1, 4, 2, 3 };
        ...
        {
            var array = new DataStructures.SortedListCollection<int> { 0, 1, 3, 4 };
            array.Add(2);
        ...
        {
            var array = new DataStructures.SortedListCollection<int> { 0, 1, 2, 3, 4 };
            array.Insert(3, 1);
        ...
        {
            var array = new DataStructures.SortedListCollection<int> { 0, 1, 2, 4, 5 };
            array.Insert(3, 3);
